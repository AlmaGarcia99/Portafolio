			...
			<div class="user-box dropdown">
				<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
					@if(Auth::user()->profile->foto)
						<img src="{{asset('imgusers/'.Auth::user()->profile->foto)}}" class="user-img" alt="user avatar">
					@else
						<img src="{{asset('imgusers/default.jpg')}}" class="user-img" alt="user avatar">
					@endif
					<div class="user-info ps-3" style="color:white;">
						@if(Auth::user()->profile->nombre_usu && Auth::user()->profile->apellidos_usu )
							{{Auth::user()->profile->nombre_usu}} {{Auth::user()->profile->apellidos_usu}}
						@else
							<p class="user-name mb-0">{{Auth::user()->name}} </p>
						@endif

						<p class="designattion mb-0">{{Auth::user()->grupo->GRUPO_NOMBRE}}</p>
					</div>
				</a>
				<ul class="dropdown-menu dropdown-menu-end">
					<li><a class="dropdown-item" href="javascript:;"><i class="bx bx-user"></i><span>Profile</span></a>
					</li>
					<li><a class="dropdown-item" href="/misAjustes"><i class="bx bx-cog"></i><span>Settings</span></a>
					</li>
