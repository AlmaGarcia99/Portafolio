      ...
      <div class="container-fluid">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Editar ejercicios de la rutina</h3>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col">
              ...
              <div class="col">
                ...
                <h4>Ejercicios</h4>
                <ul class="list-group">
                  <li class="list-group-item d-flex justify-content-between align-items-center" v-for="exercise in ejerciciosRutina" v-if="ejerciciosRutina" :key="exercise.id_exercise">
                    @{{exercise.nombre_ejercicio}}
                    <button class="badge badge-primary badge-pill" v-on:click="retirarEjercicio(exercise.id)">X</button>
                  </li>
                </ul>
                <button class="btn btn-block btn-primary mt-3" v-if="ejerciciosRutina.length>4" v-on:click="updateRutinaEjercicio()">Editar rutina</button>
              </div>
            </div>
          </div>
        </div>
...
@section('scripts')
  ...
  <script src="{{asset('js/editar-ejercicios.js')}}"></script>
@endsection